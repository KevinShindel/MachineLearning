"""
Description: Investigate USA naming data.
...
def yield_data(files: []) -> pd.DataFrame:
    """
    Yield data from files
    """
...
def add_prop(group) -> pd.DataFrame:
    """ Add prop column to group """
    group['prop'] = group.births / group.births.sum()
    return group


def get_top_1000(group) -> pd.DataFrame:
    """ Get top 1000 names from group """
