"""
Description: Linear regression model for auto-mpg dataset.
             Auto-mpg dataset contains information about cars and their fuel consumption.
             The goal is to predict fuel consumption based on car features.
...
def main():
    ...
    feature = df.drop(['mpg', 'predicted_mpg', 'error_int', 'error_%'], axis=1)
    target = df['mpg']
