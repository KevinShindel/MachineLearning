"""
Description: This script is a simple example of linear regression using the dataset of houses to rent.
             The dataset is loaded and cleaned, then the data is split into training and testing sets.
             The model is trained and evaluated, and the results are saved to a CSV file.
