"""
Description: This script is used to classify animals based on their features, using spark ml library.
Main goal is to show how to use spark ml library to classify animals based on their features.
